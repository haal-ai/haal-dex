...
function BuilderAppContent() {
  ...
  return (
    <div data-testid="builder-app-layout" className="flex flex-col h-screen bg-background text-foreground">
      <header
        data-testid="builder-top-bar"
        className="flex items-center justify-between px-4 py-2 border-b border-border bg-card"
      >
        <h1 className="text-xl font-bold" data-testid="builder-app-title">INTENT Builder</h1>
